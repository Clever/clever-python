...
class Section(object):
    ...
    def __init__(self, course_description=None, course_name=None, course_number=None, created=None, district=None, grade=None, id=None, last_modified=None, name=None, period=None, school=None, section_number=None, sis_id=None, students=None, subject=None, teacher=None, teachers=None, term=None):
        """
